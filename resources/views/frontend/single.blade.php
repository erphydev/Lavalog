                    ...
                    <article>
                        <div class="section-top-single bg-white rounded p-3">
                            <div class="row">
                                <div class="col-md-7">
                                    <figure>
                                        <img src="../../../public/frontend/img/blog/podcast.jpg" alt="" class="img-thumbnail d-table mx-auto">
                                    </figure>
                                </div>
                                <div class="col-md-5">
                        ...
                        <div class="content-single rounded bg-white p-3 mt-3">
                            ...
                            <img src="../../../public/frontend/img/blog/buisiness.jpg" alt="">
                        ...
                        <div class="rounded bg-white p-3 mt-3">
                            <div class="comments-box">
                                <div class="cm-parent rounded bg-light p-3 mb-3">
                                    <div class="row">
                                        <div class="col-1">
                                            <img src="../../../public/frontend/img/userAvatar.png" alt="">
                                        </div>
                                        <div class="col-11">
