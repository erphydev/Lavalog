        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 my-3">
                    <div class="blg-wrap bg-white pb-3">
                        <figure class="position-relative">
                            <img src="../../../public/frontend/img/blog/CSS-Contact-Us-Form.png" alt="" class="w-100">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 my-3">
                    <div class="blg-wrap bg-white pb-3">
                        <figure class="position-relative">
                            <img src="../../../public/frontend/img/blog/buisiness.jpg" alt="" class="w-100">
                            <figcaption class="position-absolute w-100 h-100"><span class="blg-dt">4 مرداد</span></figcaption>
                        </figure class="position-relative">
                        <div class="px-3 py-1 text-start">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 my-3">
                    <div class="blg-wrap bg-white pb-3">
                        <figure class="position-relative">
                            <img src="../../../public/frontend/img/blog/Piks.jpg" alt="" class="w-100">
                            <figcaption class="position-absolute w-100 h-100"><span class="blg-dt">4 مرداد</span></figcaption>
                        </figure class="position-relative">
                        <div class="px-3 py-1 text-start">
